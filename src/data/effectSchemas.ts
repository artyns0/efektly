  ...
  fluxMelt: [
    {
      kind: "select", key: "preset", label: "Preset",
      options: [
        { value: "soft-drift", label: "Soft Drift" },
        { value: "wind-pull", label: "Wind Pull" },
        { value: "liquid-smear", label: "Liquid Smear" },
        { value: "center-melt", label: "Center Melt" },
        { value: "turbulent-flow", label: "Turbulent Flow" },
      ],
      patches: {
        "soft-drift": { flowAmount: 35, direction: 90, windStrength: 15, turbulenceAmount: 25, turbulenceScale: 35, stretch: 25, diffusion: 45, falloff: 40, inward: false },
        "wind-pull": { flowAmount: 55, direction: 0, windDirection: 0, windStrength: 65, turbulenceAmount: 25, stretch: 60, scatter: 15, diffusion: 55, falloff: 25 },
        "liquid-smear": { flowAmount: 70, direction: 120, windStrength: 30, turbulenceAmount: 45, turbulenceScale: 55, stretch: 75, diffusion: 70, smoothness: 65, falloff: 30 },
        "center-melt": { flowAmount: 60, size: 55, inward: true, windStrength: 10, turbulenceAmount: 30, stretch: 45, falloff: 70, diffusion: 55 },
        "turbulent-flow": { flowAmount: 50, turbulenceAmount: 85, turbulenceScale: 70, scatter: 40, stretch: 50, diffusion: 60, windStrength: 25, falloff: 20 },
      },
    },
    { kind: "slider", key: "centerX", label: "Center X", min: 0, max: 100, step: 1, unit: "%" },
    { kind: "slider", key: "centerY", label: "Center Y", min: 0, max: 100, step: 1, unit: "%" },
    pct("size", "Size"),
    { kind: "slider", key: "aspect", label: "Aspect Ratio", min: 20, max: 200, step: 1, unit: "%" },
    { kind: "slider", key: "rotation", label: "Rotation", min: 0, max: 360, step: 1, unit: "°" },
    pct("falloff", "Falloff"),
    pct("flowAmount", "Flow Amount"),
    { kind: "slider", key: "direction", label: "Direction", min: 0, max: 360, step: 1, unit: "°" },
    { kind: "slider", key: "windDirection", label: "Wind Direction", min: 0, max: 360, step: 1, unit: "°" },
    pct("windStrength", "Wind Strength"),
    pct("scatter", "Scatter"),
    pct("stretch", "Stretch"),
    { kind: "toggle", key: "inward", label: "Inward" },
    { kind: "toggle", key: "preserve", label: "Preserve" },
    pct("turbulenceAmount", "Turbulence Amount"),
    pct("turbulenceScale", "Turbulence Scale"),
    pct("diffusion", "Diffusion"),
    pct("grain", "Grain"),
    pct("smoothness", "Smoothness"),
    pct("edgeSoftness", "Edge Softness"),
    pct("opacity", "Opacity"),
    pct("blendOriginal", "Blend with Original"),
    { kind: "toggle", key: "preserveHighlights", label: "Preserve Highlights" },
  ],
};
